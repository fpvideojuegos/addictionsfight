...
class Daniela extends Phaser.GameObjects.Sprite {
        ...
        if (!this.isInLiana) {
            if (control.down) {
                ...
                if (control.left) {
                    ...
                    /* Detener por completo cuando la velocidad es menor de 300
                       Si se disminuye el parámetro de 300, el personaje se desliza */
    ...
    moverLeftRight(dir) {
        ...
        if (this.lolo) this.lolo.flipX = this.flipX;
            ...
            // Tiempo de salto mientras siga presionada la tecla de salto
    jump() {
